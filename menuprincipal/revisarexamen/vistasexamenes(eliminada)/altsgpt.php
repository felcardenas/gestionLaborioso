...
<form action="" method="POST" class="" id="formIngresarAltSgpt" name="formIngresarAltSgpt">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarAltSgpt" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarAltSgpt()" id="btnActualizarAltSgpt" name="btnActualizarAltSgpt">
        </div>
