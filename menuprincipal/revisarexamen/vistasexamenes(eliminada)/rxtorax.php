...
<div class="row justify-content-center my-5">
    <div class="col-6">
        <h1 class="text-center">RX TÓRAX</h1>
    </div>
</div>
...
<form action="" method="POST" class="" id="formIngresarRxTorax" name="formIngresarRxTorax">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarRxTorax" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarRxTorax()" id="btnActualizarRxTorax" name="btnActualizarRxTorax">
        </div>
