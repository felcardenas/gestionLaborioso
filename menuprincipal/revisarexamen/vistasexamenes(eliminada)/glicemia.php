...
<form action="" method="POST" class="" id="formIngresarGlicemia" name="formIngresarGlicemia">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarGlicemia" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarGlicemia()" id="btnActualizarGlicemia" name="btnActualizarGlicemia">
        </div>
