...
<form action="" method="POST" class="" id="formIngresarCultivoLechoUngueal" name="formIngresarCultivoLechoUngueal">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarCultivoLechoUngueal" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarCultivoLechoUngueal()" id="btnActualizarCultivoLechoUngueal" name="btnActualizarCultivoLechoUngueal">
        </div>
