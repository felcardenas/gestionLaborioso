...
<form action="" method="POST" class="" id="formIngresarCultivoNasal" name="formIngresarCultivoNasal">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarCultivoNasal" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarCultivoNasal()" id="btnActualizarCultivoNasal" name="btnActualizarCultivoNasal">
        </div>
