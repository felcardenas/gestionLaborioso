...
<form action="" method="POST" class="" id="formIngresarElectrocardiograma" name="formIngresarElectrocardiograma">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarElectrocardiograma" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarElectrocardiograma()" id="btnActualizarElectrocardiograma" name="btnActualizarElectrocardiograma">
        </div>
