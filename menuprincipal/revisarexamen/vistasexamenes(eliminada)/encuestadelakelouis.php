...
<form action="" method="POST" class="" id="formIngresarEncuestaDeLakeLouis" name="formIngresarEncuestaDeLakeLouis">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarEncuestaDeLakeLouis" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarEncuestaDeLakeLouis()" id="btnActualizarEncuestaDeLakeLouis" name="btnActualizarEncuestaDeLakeLouis">
        </div>
