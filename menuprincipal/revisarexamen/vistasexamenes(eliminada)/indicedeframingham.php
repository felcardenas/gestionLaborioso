<div class="container" >
    ...
    <form action="" method="POST" class="" id="formIngresarIndiceDeFramingham" name="formIngresarIndiceDeFramingham">
        ...
        <input type="text" name="consulta" id="consulta" value="actualizarIndiceDeFramingham" hidden>
        ...
        <div class="row justify-content-center mb-3">
            ...
            <div class="col-4">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarIndiceDeFramingham()" id="btnActualizarIndiceDeFramingham">
            </div>
