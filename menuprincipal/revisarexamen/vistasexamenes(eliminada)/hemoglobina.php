...
<form action="" method="POST" class="" id="formIngresarHemoglobina" name="formIngresarHemoglobina">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarHemoglobina" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarHemoglobina()" id="btnActualizarHemoglobina" name="btnActualizarHemoglobina">
        </div>
