...
<form action="" method="POST" class="" id="formIngresarAltSgot" name="formIngresarAltSgot">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarAltSgot" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="actualizar" onclick="guardarAltSgot()" id="btnActualizarAltSgot" name="btnActualizarAltSgot">
        </div>
