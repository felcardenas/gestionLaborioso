...
<div class="container" >
    ...
    <div class="row justify-content-center my-5">
        ...
        <input type="text" name="consulta" id="consulta" value="actualizarEspirometriaBasal" hidden>
        <!-- <input type="text" name="select" id="select" value="actualizarEspirometriaBasal" hidden> -->
        

        <div class="row justify-content-center mb-3">

            <div class="col-4">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarEspirometriaBasal()" id="btnActualizarEspirometriaBasal">
            </div>
