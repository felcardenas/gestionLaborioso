...
<form action="" method="POST" class="" id="formIngresarProtrombina" name="formIngresarProtrombina">
    ...
    <input type="text" name="consulta" id="consulta" value="actualizarProtrombina" hidden>
    ...
    <div class="row justify-content-center mb-3">
        ...
        <div class="col-4">
            <input class="btn btn-primary btn-lg btn-block" type="button" value="Actualizar" onclick="guardarProtrombina()" id="btnActualizarProtrombina" name="btnActualizarProtrombina">
        </div>
